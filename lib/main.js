...
const getLabelsIdsToApply_1 = require("./utils/getLabelsIdsToApply");
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const labelsIdsFromTypes = types.map((type) => (0, getLabelsIdsToApply_1.getLabelsIdsToApply)(type, labels, labelsToApply));
