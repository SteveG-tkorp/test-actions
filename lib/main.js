...
const getLabelIdToApply_1 = require("./utils/getLabelIdToApply");
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const labelsToApply = (0, loadConfigFile_1.loadConfigFile)(configPath);
            const owner = github_1.context.repo.owner;
            const repo = github_1.context.repo.repo;
            const octokit = (0, github_1.getOctokit)(token);
            // Récupérer les informations principales
            const { closingIssuesIds: closingIssues, prId, labels, } = yield (0, mainRequest_1.getInfos)(owner, repo, octokit, Number(PRNumber));
            // Récupérer les types
            ...
            const labelsIdsFromTypes = types
                .map((type) => (0, getLabelIdToApply_1.getLabelIdToApply)(type, labels, labelsToApply))
