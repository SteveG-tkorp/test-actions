...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            console.log("context.payload.pull_request.head", (_a = github_1.context.payload.pull_request) === null || _a === void 0 ? void 0 : _a.head);
            console.log("context.payload.pull_request._links", (_b = github_1.context.payload.pull_request) === null || _b === void 0 ? void 0 : _b._links);
            ...
            if (PRNumber) {
                ...
                (0, functions_1.getIssueClosingPR)(owner, repo, octokit);
            }
            else if (issueNumber) {
